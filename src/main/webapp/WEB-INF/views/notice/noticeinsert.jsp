...
<body id="page-top">
	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div class="container-fluid" style="position:relative; width:1200px; height:300px; border:1 ">
			<br>
			<br>
			글&nbsp;번&nbsp;호 : <input type="text" id="NOTICE_SEQ" disabled="disabled" style="width:200px;">
			<br>
			<br>
			제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목 : <input type="text" id="NOTICE_TITLE" style="width:200px;">
			<br>
			<br>
			작&nbsp;성&nbsp;자 : <input type="text" id="NOTICE_USER_ID" style="width:200px;" disabled="disabled" value="${UserLogin.USER_ID}">
			<br>
			<br>
			<span>내&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;용 : </span>
			<br>
			<textarea id="NOTICE_CONTENTS" rows=10 cols=10 style="text-align:left; width:500px;height: 200px;" ></textarea>
			<br>
			<br>
			<a href="#" class="border-bottom-secondary btn-icon-split" onclick="fn_noticelinsert();">
		        <span class="icon text-white-50 ">
		        	<i class="fas fa-check"></i>
		        </span>
		        <span class="text">등록 하기</span>
            </a>
            <a href="/set/notice.do" class="border-bottom-secondary btn-icon-split" style="position: relative; left: 200px">
		        <span class="icon text-white-50 ">
		        	<i class="fas fa-check"></i>
		        </span>
...
function fn_seq(){
	...
	$.ajax({
		url: "/set/noticemaxseq.do",
	    type: "post",
		dataType: "json",
		success: function(data){
			console.log(data.noticemaxseq);
			if( data.noticemaxseq == 1 || data.noticemaxseq == '1'){
				$("#NOTICE_SEQ").val(data.noticemaxseq);
			}else{
				$("#NOTICE_SEQ").val(data.noticemaxseq.NOTICE_SEQ);
			}
...
function fn_noticelinsert(){
	
	var NOTICE_SEQ =$("#NOTICE_SEQ").val();
	var NOTICE_TITLE = $("#NOTICE_TITLE").val();
	var NOTICE_USER_ID = $("#NOTICE_USER_ID").val();
	var NOTICE_CONTENTS = $("#NOTICE_CONTENTS").val();
	var NOTICEINSERT = { "NOTICE_SEQ" : NOTICE_SEQ  , "NOTICE_TITLE" : NOTICE_TITLE , "NOTICE_USER_ID" : NOTICE_USER_ID  , "NOTICE_CONTENTS" : NOTICE_CONTENTS}
	$.ajax({
		url: "/set/noticeinsert.do",
	    type: "post",
		dataType: "json",
		data: NOTICEINSERT ,
		success: function(data){
			if(data.noticeinsert == '1' | data.noticeinsert == 1){
				alert("등록 되었습니다");
