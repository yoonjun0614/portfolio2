		...
		<div class="container-fluid">
			...
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h6 class="m-0 font-weight-bold text-primary">건의 사항</h6>
				</div>
				...
				<div class="card-body">
					...
					<a href="/set/suggestionsenrollment.do" class="border-bottom-secondary btn-icon-split">
...
function fn_suggestionslist(){
	

	$.ajax({
	
		url: "/set/suggestionslist.do",
	    type: "post",
		dataType: "json",
		success: function(data){
	
				for(var i=0 ; i<data.suggestionslist.length ; i++){
				console.log(data.suggestionslist);
				...
				tr.setAttribute("onclick","fn_suggestionsdatail('"+data.suggestionslist[i].SUGGESTIONS_SEQ+"');");

// 				tr.setAttribute("onclick","location.href='suggestions/suggestionsupdate?seq="+data.suggestionslist[i].SEQ+"");
				
				
				td1.innerHTML = data.suggestionslist[i].SUGGESTIONS_SEQ;
				td2.innerHTML = data.suggestionslist[i].SUGGESTIONS_TITLE;
				td3.innerHTML = data.suggestionslist[i].SUGGESTIONS_USER_ID;
				td4.innerHTML = data.suggestionslist[i].SUGGESTIONS_CREATEDATE;
				td5.innerHTML = data.suggestionslist[i].SUGGESTIONS_UPDATEDATE;
				...
				tr.appendChild(td4);
				tr.appendChild(td5);
				document.getElementById("suggestionTable").appendChild(tr);
			}
...
function fn_suggestionsdatail(seq){
	
	var suggestionsseq= {"SUGGESTIONS_SEQ" : seq};
	console.log(suggestionsseq); 
	
	
	$.ajax({
		url: "/set/suggestionsdetail.do",
	    type: "post",
		dataType: "json",
		data:suggestionsseq ,
		success: function(data){

 			window.location.href = "/set/suggestionsupdatedetail.do?SUGGESTIONS_SEQ="+data.suggestionsdatail.SUGGESTIONS_SEQ+"";
		},
	});
