...
<body id="page-top">
	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<h1 class="h3 mb-2 text-gray-800">비상 연락망</h1>
		...
		<div class="container-fluid">
			...
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">비상 연락망</h6>
			</div>
			<div class="card-body">
...
$.ajax({
	...
	success: function(data){
			...
			td1.innerHTML = data.userlist[i].USER_ID;
			td1.setAttribute("text",td1.innerHTML);
			td2.innerHTML = data.userlist[i].USER_NM;
			if(data.userlist[i].TEAM_CD == '1' | data.userlist[i].TEAM_CD == 0){
				td3.innerHTML = "개발팀";
			}else if(data.userlist[i].TEAM_CD == '2' | data.userlist[i].TEAM_CD == 1){
				td3.innerHTML = "영업팀";
			}else{
				td3.innerHTML = "인사팀";
			}
			td4.innerHTML = data.userlist[i].TEL;
			td5.innerHTML = data.userlist[i].EMAIL;
			td6.innerHTML = data.userlist[i].POWER;
			

			if(data.userlist[i].POWER == '1' | data.userlist[i].POWER == 0){
				td6.innerHTML = "사원";
			}else if(data.userlist[i].POWER == '2' | data.userlist[i].POWER == 1){
				td6.innerHTML = "대리";
			}else if(data.userlist[i].POWER == '3' | data.userlist[i].POWER == 2){
				td6.innerHTML = "과장";
			}else{
				td6.innerHTML = "부장";
			}
