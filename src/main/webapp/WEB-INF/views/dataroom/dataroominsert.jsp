...
<body id="page-top">
	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<h1 class="h3 mb-2 text-gray-800"> 자료 등록 </h1>
		...
		<div class="container-fluid" style="position:relative; width:1200px; height:300px; border:1 ">
			<br>
			<br>
			글&nbsp;번&nbsp;호 : <input type="text" id="DATAROOM_SEQ" disabled="disabled" style="width:200px;" >
			<br>
			<br>
			제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목 : <input type="text" id="DATAROOM_TITLE" style="width:200px;" >
			<br>
			<br>
			작&nbsp;성&nbsp;자 : <input type="text" id="DATAROOM_USER_ID" style="width:200px;" disabled="disabled" value="${UserLogin.USER_ID}">
			<br>
			<br>
			<a href="#" class="border-bottom-secondary btn-icon-split" onclick="fn_dataroominsert();">
		        <span class="icon text-white-50 ">
		        	<i class="fas fa-check"></i>
		        </span>
		        <span class="text">등록 하기</span>
            </a>
            <a href="/set/dataroom.do" class="border-bottom-secondary btn-icon-split" style="position: relative; left: 200px">
		        <span class="icon text-white-50 ">
		        	<i class="fas fa-check"></i>
		        </span>
...
function fn_seq(){
	...
	$.ajax({
		url: "/set/dataroommaxseq.do",
	    type: "post",
		dataType: "json",
		success: function(data){
			console.log(data.noticemaxseq);
			if( data.dataroommaxseq == 1 || data.dataroommaxseq == '1'){
				$("#DATAROOM_SEQ").val(data.dataroommaxseq);
			}else{
				$("#DATAROOM_SEQ").val(data.dataroommaxseq.DATAROOM_SEQ);
			}
...
function fn_dataroominsert(){
	
	var DATAROOM_SEQ =$("#DATAROOM_SEQ").val();
	var DATAROOM_TITLE = $("#DATAROOM_TITLE").val();
	var DATAROOM_USER_ID = $("#DATAROOM_USER_ID").val();
	var DATAROOMINSERT = { "DATAROOM_SEQ" : DATAROOM_SEQ  , "DATAROOM_TITLE" : DATAROOM_TITLE , "DATAROOM_USER_ID" : DATAROOM_USER_ID }
	$.ajax({
		url: "/set/dataroominsert.do",
	    type: "post",
		dataType: "json",
		data: DATAROOMINSERT ,
		success: function(data){
			if(data.dataroominsert == '1' | data.dataroominsert == 1){
				alert("등록 되었습니다");
