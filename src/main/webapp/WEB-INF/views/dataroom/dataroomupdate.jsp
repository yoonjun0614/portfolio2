...
<body id="page-top">
	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<h1 class="h3 mb-2 text-gray-800"> 자료실 > 수정 및 삭제  </h1>
		...
		<div class="container-fluid" style="position:relative; width:1200px; height:300px; border:1 ">
			<br>
			<br>
			글&nbsp;번&nbsp;호 : <input type="text" id="DATAROOM_SEQ" disabled="disabled" style="width:200px;" value="${dataroomdetail.DATAROOM_SEQ}">
			<br>
			<br>
			<c:if test="${dataroomdetail.DATAROOM_USER_ID eq UserLogin.USER_ID}">
				제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목 : <input type="text" id="DATAROOM_TITLE" style="width:200px;" value="${dataroomdetail.DATAROOM_TITLE}">
			</c:if>
			<c:if test="${dataroomdetail.DATAROOM_USER_ID ne UserLogin.USER_ID}">
				제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목 : <input type="text" id="DATAROOM_TITLE" style="width:200px;" disabled="disabled" value="${dataroomdetail.DATAROOM_TITLE}">
			</c:if>			
			<br>
			<br>
			작&nbsp;성&nbsp;자 : <input type="text" id="DATAROOM_USER_ID" style="width:200px;" disabled="disabled" value="${dataroomdetail.DATAROOM_USER_ID}">
			<br>
			<br>
			<c:if test="${dataroomdetail.DATAROOM_USER_ID eq UserLogin.USER_ID}">
				<a href="#" class="border-bottom-secondary btn-icon-split" onclick="fn_dataroomupdate();">
			        <span class="icon text-white-50 ">
			        	<i class="fas fa-check"></i>
			        </span>
			        <span class="text">수정 하기</span>
	            </a>
				<a href="#" class="border-bottom-secondary btn-icon-split" onclick="fn_dataroomdelete();" style="position: relative; left: 50px">
			        <span class="icon text-white-50 ">
			        	<i class="fas fa-check"></i>
			        </span>
			        <span class="text">삭제 하기</span>
	            </a>      		
	            <a href="/set/dataroom.do" class="border-bottom-secondary btn-icon-split" style="position: relative; left: 100px">
			        <span class="icon text-white-50 ">
			        	<i class="fas fa-check"></i>
			        </span>
			...
			<c:if test="${dataroomdetail.DATAROOM_USER_ID ne UserLogin.USER_ID}">
	            <a href="/set/dataroom.do" class="border-bottom-secondary btn-icon-split" style="position: relative; left: 380px">
			        <span class="icon text-white-50 ">
			        	<i class="fas fa-check"></i>
			        </span>
			        <span class="text">목록으로</span>
...
function fn_dataroomupdate(){

	var DATAROOM_TITLE =$("#DATAROOM_TITLE").val();
	var DATAROOM_SEQ =$("#DATAROOM_SEQ").val();
	...
	var DATAROOMUPDATE = {"DATAROOM_TITLE" : DATAROOM_TITLE ,  "DATAROOM_SEQ" : DATAROOM_SEQ };
	
	$.ajax({
		url: "/set/dataroomupdate.do",
	    type: "post",
		dataType: "json",
		data: DATAROOMUPDATE ,
		success: function(data){
			if(data.dataroomupdate == '1' | data.dataroomupdate == 1){
				alert("수정되었습니다");
				window.location.href = "/set/dataroom.do";
			}else{
...
function fn_dataroomdelete(){
	
	var DATAROOM_SEQ =$("#DATAROOM_SEQ").val();
	
	var DATAROOMDELETE = { "DATAROOM_SEQ" : DATAROOM_SEQ  };
	
	$.ajax({
		url: "/set/dataroomdelete.do",
	    type: "post",
		dataType: "json",
		data: DATAROOMDELETE ,
		success: function(data){
			if(data.dataroomdelete == '1' | data.dataroomdelete == 1){
				alert("삭제 되었습니다");
				window.location.href = "/set/dataroom.do";
			}else{
