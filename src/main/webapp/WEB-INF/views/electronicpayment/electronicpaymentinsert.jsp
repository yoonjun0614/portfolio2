...
<body id="page-top">
	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<h1 class="h3 mb-2 text-gray-800"> 전자 결제 등록 </h1>
		...
		<div class="container-fluid" style="position:relative; width:1200px; height:300px; border:1 ">
			<br>
			<br>
			글&nbsp;번&nbsp;호 : <input type="text" id="ELECTRONICPAYMENT_SEQ" disabled="disabled" style="width:200px;">
			<br>
			<br>
			제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목 : <input type="text" id="ELECTRONICPAYMENT_TITLE" style="width:200px;">
			<br>
			<br>
			작&nbsp;성&nbsp;자 : <input type="text" id="ELECTRONICPAYMENT_USER_ID" style="width:200px;" disabled="disabled" value="${UserLogin.USER_ID}">
			<br>
			<br>
			<span>내&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;용 : </span>
			<br>
			<textarea id="ELECTRONICPAYMENT_CONTENTS" rows=10 cols=10 style="text-align:left; width:500px;height: 200px;" ></textarea>
			<br>
			<br>
			<a href="#" class="border-bottom-secondary btn-icon-split" onclick="fn_electronicpaymentinsert();">
...
function fn_seq(){
	...
	$.ajax({
		url: "/set/electronicpaymentmaxseq.do",
	    type: "post",
		dataType: "json",
		success: function(data){
			console.log(data.electronicpaymentmaxseq);
			if( data.electronicpaymentmaxseq == 1 || data.electronicpaymentmaxseq == '1'){
				$("#ELECTRONICPAYMENT_SEQ").val(data.electronicpaymentmaxseq);
			}else{
				$("#ELECTRONICPAYMENT_SEQ").val(data.electronicpaymentmaxseq.ELECTRONICPAYMENT_SEQ);
			}
...
function fn_electronicpaymentinsert(){
	
	var ELECTRONICPAYMENT_SEQ =$("#ELECTRONICPAYMENT_SEQ").val();
	var ELECTRONICPAYMENT_TITLE = $("#ELECTRONICPAYMENT_TITLE").val();
	var ELECTRONICPAYMENT_USER_ID = $("#ELECTRONICPAYMENT_USER_ID").val();
	var ELECTRONICPAYMENT_CONTENTS = $("#ELECTRONICPAYMENT_CONTENTS").val();
	
	if("${UserLogin.POWER}"== '1' ||  "${UserLogin.POWER}" ==1 || "${UserLogin.POWER}"== '2' ||  "${UserLogin.POWER}" ==2){
		var ELECTRONICPAYMENT_STATE = "1";
	}else{
		var ELECTRONICPAYMENT_STATE = "2";	
	}
	
	var ELECTRONICPAYMENTINSERT = { "ELECTRONICPAYMENT_SEQ" : ELECTRONICPAYMENT_SEQ  , "ELECTRONICPAYMENT_TITLE" : ELECTRONICPAYMENT_TITLE  , "ELECTRONICPAYMENT_USER_ID" : ELECTRONICPAYMENT_USER_ID , "ELECTRONICPAYMENT_CONTENTS" : ELECTRONICPAYMENT_CONTENTS , "ELECTRONICPAYMENT_STATE" : ELECTRONICPAYMENT_STATE }
	$.ajax({
		url: "/set/electronicpaymentinsert.do",
	    type: "post",
		dataType: "json",
		data: ELECTRONICPAYMENTINSERT ,
		success: function(data){
			if(data.electronicpaymentinsert == '1' | data.electronicpaymentinsert == 1){
				alert("등록 되었습니다");
				window.location.href = "/set/electronicpayment.do";
			}else{
				alert("오류로 인하여 등록되지 않았습니다");
			}
		},
	});
